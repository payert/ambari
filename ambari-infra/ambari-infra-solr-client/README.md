...
```bash
# by default, you will migrate to Lucene 6.6.2, if you want to migrate again to Solr 7 (not requred), you can use --version 7.7.2 flag
...
Options:
  ...
  --version=INDEX_VERSION
                        lucene index version for migration (6.6.2 or 7.7.2)
